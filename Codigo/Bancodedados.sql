...
CREATE TABLE Veiculo (
    ...
    IdServico INT UNSIGNED NOT NULL,
		...
		FOREIGN KEY (IdServico) REFERENCES Servico(IdServico)
				...
				(2 , 'Ciclano' , '$2y$10$.k0afkzympQV/2fXYmuHh.h3PfE5nFqGbRHTHVqOo5vwGne4DfscK', 'rua qualquer' , '26598741' , '2000-08-30', 'ciclano@gmail.com');
				(3 , 'Ciclano' , '$2y$10$.k0afkzympQV/2fXYmuHh.h3PfE5nFqGbRHTHVqOo5vwGne4DfscK', 'rua qualquer' , '26598741' , '2000-08-30', 'fulano@gmail.com');
				INSERT INTO pessoa_fisica VALUES
				(2 , '14785236901');
				(3 , '14785236900100');
				INSERT INTO gerenciamento VALUES (1 , 'Beltrano' , '$2y$10$.k0afkzympQV/2fXYmuHh.h3PfE5nFqGbRHTHVqOo5vwGne4DfscK', 'rua qualquer' , '26598741' , '2000-08-30', 'gerente@gmail.com', '14785236902' );
				INSERT INTO servico VALUES (1 , 140 , 15, '2018-04-15' ,'veículo', 2 , 1);
